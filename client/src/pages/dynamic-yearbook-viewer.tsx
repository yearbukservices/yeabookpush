...
export default function DynamicYearbookViewer() {
  ...
  // Update orientation based on yearbook settings
  useEffect(() => {
    if (yearbook?.orientation) {
      setIsPortrait(yearbook.orientation === 'portrait');
      // Note: viewMode starts as 'cover' to show front cover first
      // It will change to 'single' or 'spread' when user navigates from cover
    }
      ...
      return (
        <div className="flex justify-center items-center min-h-[60vh] sm:min-h-[70vh] relative">
          <div 
            ...
            style={{
              width: isPortrait ? '420px' : '1040px',
              height: isPortrait ? '570px' : '780px',
              maxWidth: '90vw'
            }}
          >
            <div 
      ...
      if (isPortrait) {
        ...
        if (viewMode === 'single') {
          return (
            <div className="flex justify-center items-center min-h-[60vh] sm:min-h-[70vh] relative">
              <div 
                ref={viewportRef}
                className="relative overflow-hidden border border-gray-200 shadow-lg w-full max-w-[420px]"
                style={{
                  aspectRatio: '3/4',
                  maxWidth: '90vw'
                }}
        ...
        return (
          <div className="flex justify-center items-center min-h-[60vh] sm:min-h-[70vh] relative">
            <div 
              ref={viewportRef}
              className="relative overflow-hidden border border-gray-200 shadow-lg w-full max-w-[884px]"
              style={{
                aspectRatio: '884/572',
                maxWidth: '90vw'
              }}
        ...
        return (
          <div className="flex justify-center items-center min-h-[60vh] sm:min-h-[70vh] relative">
            <div 
              ref={viewportRef}
              className="relative overflow-hidden border border-gray-200 shadow-2xl w-full max-w-[1040px]"
              style={{
        ...
        return (
          <div className="flex justify-center items-center min-h-[60vh] sm:min-h-[70vh] relative">
            <div 
              ref={viewportRef}
              className="relative overflow-hidden border border-gray-200 shadow-2xl w-full max-w-[1430px]"
              style={{
                aspectRatio: '1430/585',
                maxWidth: '95vw'
              }}
            >
              <div 
